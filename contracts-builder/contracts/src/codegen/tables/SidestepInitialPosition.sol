...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SidestepInitialP")));
bytes32 constant SidestepInitialPositionTableId = _tableId;

library SidestepInitialPosition {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[1] = "x";
    _fieldNames[2] = "y";
    return ("SidestepInitialPosition", _fieldNames);
  }
  ...
  function setActive(bytes32 key, bool active) internal {
    ...
    StoreSwitch.setField(_tableId, _primaryKeys, 0, abi.encodePacked((active)));
  }
  ...
  function setActive(IStore _store, bytes32 key, bool active) internal {
    ...
    _store.setField(_tableId, _primaryKeys, 0, abi.encodePacked((active)));
  }
  ...
  function setX(bytes32 key, uint32 x) internal {
    ...
    StoreSwitch.setField(_tableId, _primaryKeys, 1, abi.encodePacked((x)));
  }
  ...
  function setX(IStore _store, bytes32 key, uint32 x) internal {
    ...
    _store.setField(_tableId, _primaryKeys, 1, abi.encodePacked((x)));
  }
  ...
  function setY(bytes32 key, uint32 y) internal {
    ...
    StoreSwitch.setField(_tableId, _primaryKeys, 2, abi.encodePacked((y)));
  }
  ...
  function setY(IStore _store, bytes32 key, uint32 y) internal {
    ...
    _store.setField(_tableId, _primaryKeys, 2, abi.encodePacked((y)));
  }

  /** Get the full data */
  function get(bytes32 key) internal view returns (bool active, uint32 x, uint32 y) {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32((key));
  ...
  function get(IStore _store, bytes32 key) internal view returns (bool active, uint32 x, uint32 y) {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32((key));
  ...
  function set(bytes32 key, bool active, uint32 x, uint32 y) internal {
    bytes memory _data = encode(active, x, y);
  ...
  function set(IStore _store, bytes32 key, bool active, uint32 x, uint32 y) internal {
    bytes memory _data = encode(active, x, y);
  ...
  function decode(bytes memory _blob) internal pure returns (bool active, uint32 x, uint32 y) {
    active = (_toBool(uint8(Bytes.slice1(_blob, 0))));

    x = (uint32(Bytes.slice4(_blob, 1)));

    y = (uint32(Bytes.slice4(_blob, 5)));
  }

  /** Tightly pack full data using this table's schema */
  function encode(bool active, uint32 x, uint32 y) internal view returns (bytes memory) {
    return abi.encodePacked(active, x, y);
  }
